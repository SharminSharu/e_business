      ...
      <div class="container-fluid">
              ...
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="col-6">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="summernote" name="msg">  value="<?php echo $data['msg'] ?>" </textarea>
                    </div>
        ...
        <div class="card card-primary card-outline">
              ...
              <div class="container">
                ...
                <tr>
                    <th>Title_3</th>
                    <td><input type="text" name="subject" value="<?php echo $data['subject'] ?>" class="form-control"></td>
                </tr>
                <tr>
