...
if(isset($_POST['title_1'])){
    ...
    $query="INSERT INTO `portfolio` (`id`, `photo`, `title_1`, `title_2`) VALUES (NULL, '$file','$t_1', '$t_2')";
    $db->query($query);
        ...
        <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <?php $i=0; while($data=$portfolio->fetch_assoc()){ ?>
                        <tr>
                            <td><?php echo ++$i ?></td>
                            ...
                            <td><a href="delete_slider.php" class="btn btn-danger btn-xs">Delete</a></td> -->
                               ...
                               <td>
                                ...
                                <a href="edit_portfolio.php?id=<?php echo $data['id'] ?>" class="btn btn-xs btn-success">Edit</a>   
                                <a href="delete_portfolio.php?id=<?php echo $data['id'] ?>" class="btn btn-xs btn-danger"
