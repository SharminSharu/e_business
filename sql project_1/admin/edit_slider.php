      ...
      <div class="container-fluid">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" name="photo" class="custom-file-input" id="exampleInputFile" value="<?php echo $data['photo'] ?>" >
        ...
        <div class="card card-primary card-outline">
              ...
              <div class="container">
                ...
                <tr>
                    <th>Title_3</th>
                    <td><input type="text" name="title_3" value="<?php echo $data['title_3'] ?>" class="form-control"></td>
                </tr>
