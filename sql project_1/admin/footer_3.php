...
if(isset($_POST['title'])){
    ...
    $query="INSERT INTO `footer_3` (`id`, `title`, `photo`) VALUES (NULL, '$t', '$file')";
    $db->query($query);
          ...
          <div class="col-lg-12">
            ...
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h5 class="m-0">Add new footer_3</h5>
              </div>
              <div class="card-body">
        ...
        <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <?php $i=0; while($data=$footer_3->fetch_assoc()){ ?>
                        <tr>
                            <td><?php echo ++$i ?></td>
                            ...
                            <td><a href="delete_slider.php" class="btn btn-danger btn-xs">Delete</a></td> -->
                               ...
                               <td>
                                ...
                                <a href="edit_footer_3.php?id=<?php echo $data['id'] ?>" class="btn btn-xs btn-success">Edit</a>   
                                <a href="delete_footer_3.php?id=<?php echo $data['id'] ?>" class="btn btn-xs btn-danger"
