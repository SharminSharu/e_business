    ...
    <div class="content">
      <div class="container-fluid">
              ...
              <form action="contact_update.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="first" class="form-control" id="exampleInputEmail1" placeholder="Enter first name"   value="<?php echo $data['first'] ?>" >
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Last Name</label>
                        <input type="text" name="last" class="form-control" id="exampleInputEmail1" placeholder="Enter last name"   value="<?php echo $data['last'] ?>" >
                    </div>
                    <div class="form-group">
        ...
        <div class="card card-primary card-outline">
              ...
              <div class="card-body">
              <div class="container">
                <form action="update_form.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data">
