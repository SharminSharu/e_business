...
if(isset($_POST['title_1'])){
    ...
    $query="INSERT INTO `slider` (`id`, `photo`, `title_1`, `title_2`, `title_3`) VALUES (NULL, '$file','$t_1', '$t_2', '$t_3')";
    $db->query($query);
                        ...
                        <tr>
                            ...
                            <td><a href="delete_slider.php" class="btn btn-danger btn-xs">Delete</a></td> -->
                               ...
                               <td>
                                ...
                                <a href="edit_slider.php?id=<?php echo $data['id'] ?>" class="btn btn-xs btn-success">Edit</a>   
                                <a href="delete_slider.php?id=<?php echo $data['id'] ?>" class="btn btn-xs btn-danger"
