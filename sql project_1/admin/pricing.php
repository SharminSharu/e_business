...
if(isset($_POST['title'])){
    ...
    $query="INSERT INTO `price_title` (`id`, `title`, `money`) VALUES (NULL, '$t', '$money')";
    $db->query($query);
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
              ...
              <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="col-4">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="money" class="form-control" id="exampleInputEmail1" placeholder="Enter money ">
                      </div>
        ...
        <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                <table class="table table-bordered" class="pr">
                    <tr>
                        <th>SL</th>
                        <th>title</th>
                        <th>money</th>
                    ...
                    <?php $i=0; while($data=$price_1->fetch_assoc()){ ?>
                        <tr>
                            <td><?php echo ++$i ?></td>
    ...
    <a href="edit_pricing.php?id=<?php echo $data['id'] ?>" class="btn btn-xs btn-success">Edit</a>   
    <a href="delete_pricing.php?id=<?php echo $data['id'] ?>" class="btn btn-xs btn-danger"
