...
if(isset($_POST['title'])){
   ...
   $query="INSERT INTO `blog` (`id`, `photo`, `title`, `description`) VALUES (NULL, '$file', '$title', '$details')";
    $db->query($query);
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <a href="blog_delete.php?id=<?php echo $data['id'] ?>" class="btn btn-xs btn-danger"
